...
# this was to keep track and ensure the database was
#  not duplicated everytime the code was ran
#     print("table created")
# else:
#     print("table here")

# SQLite does not have a dedicated BOOLEAN data type.
# Instead, it treats BOOLEAN as an alias for INTEGER.
# I kept it as an integer as I want to be able to easily
# do numeric comparisons. Instead of making it TEXT NOT NULL,
# I figured this is best
# Also used email address as the unique identifier
...
# cleaning the data is taking out the booleans
#  and replacing all the
...
# This was to check it was working and print
# the database to terminal
# for r in rows:
#     print(r)
