...
def update_suggestions(search_var, suggestion_list):
    ...
    try:
        ...
        # stops the app crashing if database or tkinter fails
        pass


def select_suggestion(search_var, suggestion_list, perform_search):
    ...
    try:
        if suggestion_list.curselection():
            ...
            selected_suggestion = suggestion_list.get(
...
def perform_search(search_var, details_label):
    ...
    try:
        ...
        if not search_term:
            details_label.config(text="Please enter a name.")
            return
        ...
        for student in students:
            ...
            Assignment Completed: {(student[7])}
            Grade: {student[8]}
            -------------------------
            """
